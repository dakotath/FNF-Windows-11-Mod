	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'sheldon':
				tex = Paths.getSparrowAtlas('characters/sheldon', 'shared');
				frames = tex;
				...
				animation.addByPrefix('idle', 'sheldon idle dance00', 24);
				animation.addByPrefix('singUP', 'sheldon NOTE UP00', 24);
				animation.addByPrefix('singRIGHT', 'sheldon NOTE RIGHT', 24);
				animation.addByPrefix('singDOWN', 'sheldon NOTE DOWN00', 24);
				animation.addByPrefix('singLEFT', 'sheldon NOTE LEFT00', 24);
